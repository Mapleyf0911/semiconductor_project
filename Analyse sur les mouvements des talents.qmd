...
modelsummary(
  ...
  gof_map = c("nobs", "r.squared"), 
  output = "markdown",          
  title = "Two-Way Fixed Effects Panel Regressions (Country & Year): Semiconductor Node Size vs. Talent Net Flows, Lags 1–5 Years"
)
```
...
model3_3 <- plm(
  formula = yield_rate_filled ~ net_flow + factor(nanometer),  
  data = panel_data_filled,
  index = c("country", "year"),
  model = "within",
  effect = "individual",
...
model3_3lag1 <- plm(
  yield_rate_filled ~ lag(net_flow, 1) + factor(nanometer),   
  data = panel_data_filled,
  index = c("country", "year"),
  model = "within",
  effect = "individual",
...
model3_3lag2 <- plm(
  yield_rate_filled ~ lag(net_flow, 2) + factor(nanometer),   
  data = panel_data_filled,
  index = c("country", "year"),
  model = "within",
  effect = "individual",
...
model3_3lag3 <- plm(
  yield_rate_filled ~ lag(net_flow, 3) + factor(nanometer),   
  data = panel_data_filled,
  index = c("country", "year"),
  model = "within",
  effect = "individual",
...
model3_3lag4 <- plm(
  yield_rate_filled ~ lag(net_flow, 4) + factor(nanometer),   
  data = panel_data_filled,
  index = c("country", "year"),
  model = "within",
  effect = "individual",
...
model3_3lag5 <- plm(
  yield_rate_filled ~ lag(net_flow, 5) + factor(nanometer),   
  data = panel_data_filled,
  index = c("country", "year"),
  model = "within",
  effect = "individual",
...
models3_netflow <- list(
  "Net Flow (t)"   = model3_3,
  "Net Flow (t-1)" = model3_3lag1,
  "Net Flow (t-2)" = model3_3lag2,
  "Net Flow (t-3)" = model3_3lag3,
  "Net Flow (t-4)" = model3_3lag4,
  "Net Flow (t-5)" = model3_3lag5
)
...
models4_netflow <- list(
  "Net Flow (t)"   = model4_3,
  "Net Flow (t-1)" = model4_3lag1,
  "Net Flow (t-2)" = model4_3lag2,
  "Net Flow (t-3)" = model4_3lag3,
  "Net Flow (t-4)" = model4_3lag4,
  "Net Flow (t-5)" = model4_3lag5
)
...
modelsummary(
  ...
  gof_map = c("nobs", "r.squared"), 
  output = "markdown",          
  title = "Two-Way Fixed Effects Panel Regressions (Country & Year): Yield Rate vs Talent Netflows, Lags 1–5 Years",
  coef_omit = "factor\\(nanometer\\)"
)
